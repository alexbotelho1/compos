...
<table border="0" cellpadding="0" cellspacing="0" width="780" align="center">		  
	<tr>
		...
		<% If rsbanco.AbsolutePage > 1 Then %>
			<a href="consultas2.asp?Ordem=<% = Disposicao %>&page=<% = (rsbanco.AbsolutePage - 1) %>"><img src="paganterior2.gif" align="absmiddle" border="0"></a>
		<% Else %>
		...
		<% If rsbanco.AbsolutePage < rsbanco.PageCount Then %>
      		<a href="consultas2.asp?Ordem=<% = Disposicao %>&page=<% = (rsbanco.AbsolutePage + 1) %>"><img src="pagseguinte2.gif" align="absmiddle" border="0"></a>
   		<% 	Else %>
...
<tr>
	  <td class="fundo1" width="50" height="29" align="center"><a href="consultas2.asp?Ordem=1&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;<font size="2"><b>N°</b></font>&nbsp;<a href="consultas2.asp?Ordem=2&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></a></td>
      <td class="fundo1" width="130" height="29" align="center"><!--<a href="consultas2.asp?Ordem=3"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;&nbsp;&nbsp;--><font size="2"><b>Data</b></font><!--&nbsp;&nbsp;&nbsp;&nbsp;<a href="consultas2.asp?Ordem=4"><img border="0" src="seta2.gif" alt="Decrescente"></a>--></td>
      <td class="fundo1" width="80" height="29" align="center"><b><font size="2">Periférico</td>
	  ...
	  <td class="fundo1" width="40" height="29" align="center"><b><font size="2">Opções</td>	     
	  <td class="fundo1" width="80" height="20" align="center"><b><font size="2"><a href="consultas2.asp?Ordem=3&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;<font size="2"><b>OS N°</b></font>&nbsp;<a href="consultas2.asp?Ordem=4&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></a></font></td> 	    
</tr>
<% 	HowMany = 0
...
<tr>
      ...
      <td class="fundo5" width="130" height="29" align="center"><font size="2"><% = rsbanco("os_solicdata") %></td>
      <td class="fundo5" width="80" height="29" align="center"><font size="2"><% = rsbanco("os_solicperiferico") %></td>
...
<% Else
	...
	End If %>
      ...
      <a href="alt_solicitacao.asp?codsolic=<% = rsbanco("os_codigo") %>"><img border="0" src="editar.gif" alt="Editar a Solicitação"></a>&nbsp;&nbsp;
      <% If Session("Level") < 3 Then %><a href="exc_solicitacao.asp?codsolic=<% = rsbanco("os_codigo") %>"><img border="0" src="del.gif" alt="Excluir a Solicitação"></a><% End If %></td>	
...
<table border="0" cellpadding="0" cellspacing="0" width="780" align="center">		  
	<tr>
		<td align="center" width="200">
		<% If pagina > 1 Then %>
			<a href="consultas2.asp?Ordem=<% = Disposicao %>&page=<% = (pagina - 1) %>"><img src="paganterior2.gif" align="absmiddle" border="0"></a>
		<% Else %>
			<img src="paganterior1.gif" align="absmiddle">
		<% End If %>
		</td>
		...
		<% If pagina < contador Then %>
      		<a href="consultas2.asp?Ordem=<% = Disposicao %>&page=<% = (pagina + 1) %>"><img src="pagseguinte2.gif" align="absmiddle" border="0"></a>
   		<% 	Else %>
          	<img src="pagseguinte1.gif" align="absmiddle">
    	<% 	End If %>    			    		
       	</td>
