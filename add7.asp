...
If Trim(Request.querystring("impressora_data")) = "" Or	Trim(Request.querystring("impressora_fcg")) = "" Or Trim(Request.querystring("impressora_secao")) = "" Or Trim(Request.querystring("impressora_esquadrao")) = "" Or Trim(Request.querystring("impressora_marca")) = "0" Or Trim(Request.querystring("impressora_modelo")) = "0" Or Trim(Request.querystring("impressora_impressao")) = "0" Or Trim(Request.querystring("impressora_cor")) = "" Or Trim(Request.querystring("impressora_consumo")) = "0" Or Trim(Request.querystring("impressora_situacao")) = "0" Or Trim(Request.querystring("impressora_observa")) = "" Then
...
Else
	...
	rsbanco.AddNew
	rsbanco("impressora_data")=impressora_data
	rsbanco("impressora_fcg")=impressora_fcg
	rsbanco("impressora_secao")=impressora_secao
	rsbanco("impressora_esquadrao")=impressora_esquadrao	
	rsbanco("impressora_marca")=impressora_marca
	rsbanco("impressora_modelo")=impressora_modelo
	rsbanco("impressora_impressao")=impressora_impressao
	rsbanco("impressora_cor")=impressora_cor	
	rsbanco("impressora_colorido")=impressora_colorido
	rsbanco("impressora_preto")=impressora_preto
	rsbanco("impressora_toner")=impressora_toner
	rsbanco("impressora_consumo")=impressora_consumo
	rsbanco("impressora_situacao")=impressora_situacao
	rsbanco("impressora_observa")=impressora_observa	
	rsbanco.Update
	
	rsbanco.movelast %>
<body><center><form action="adicionar5.asp">
...
<table border="1" width="599" height="1">
      ...
      <tr>
        ...
        <td class="fundo3" width="210" height="23"><% = rsbanco("impressora_marca") %></td>      
      ...
      <tr>
        ...
        <td class="fundo3" width="210" height="23"><% = rsbanco("impressora_cor") %></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="fundo3" width="210" height="23"><% = rsbanco("impressora_preto") %></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="fundo3" width="210" height="23"><% = rsbanco("impressora_situacao") %></td>
      </tr>
      <tr>
