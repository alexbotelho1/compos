...
<% 	set rsbanco=server.createobject("ADODB.Recordset")
		rsbanco.open "Select * from marcanb",banco,AdOpenKeySet,AdLockOptimistic
		
If Trim(Request.querystring("marcanb_nome")) = "" Then
...
Else
	...
	marcanb_nome=request.querystring("marcanb_nome")
	
	rsbanco.AddNew
	rsbanco("marcanb_nome")=marcanb_nome
	rsbanco.Update
