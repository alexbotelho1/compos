...
<%  If Session("LoggedIn") = True Then
	...
	ano=CInt(request.querystring("os_ano"))
...
<% Else %>    
	<tr>
    	<td width="700" height="23" colspan="2" align="center" style="border-left: 1px solid #000000; border-right: 1px solid #000000; border-top: 1px solid #000000; border-bottom-width: 1"><i><b>Relatório Anual das Ordem de Serviços do Exercício de <% = ano %></b></i></td>
    </tr>    
    </table>
