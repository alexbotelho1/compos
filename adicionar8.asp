...
<body><center><form method="GET" action="add10.asp">
<table border="1" width="600" height="102">
    <tr>
      ...
      <p style="margin-top: 0; margin-bottom: 0"><font color="#070E5A"><b>Adicionar Switch</b></font></td>
    </tr>
</table>
<table border="1" width="599" height="1">
      <tr>
        <td class="fundo1" width="90" height="23" align="center"><b>Data</b></td>
        <td class="fundo3" width="210" height="23"><input readonly name="switch_data" type="text" value="<% Response.write Now %>" size="20" style="border-style: inset; border-width: 5; text-align:center"></td>
        <td class="fundo1" width="90" height="23" align="center"><b>FCG</b></td>
        <td class="fundo3" width="210" height="23"><input type="text" name="switch_fcg" size="12" style="border-style: inset; border-width: 5"></td>
      </tr>     
      <tr>
...
<% If Session("Level") = 4 Then %>         
		<input name="switch_esquadrao" type="text" readOnly value="<% = Session("Esquadrao")%>" size="20" style="border-style: inset; border-width: 5; text-align:center">        
<% Else
...
End If %>
	...
	<% 	rsbanco2.Close
      ...
      <tr>
        ...
        <td class="fundo3" width="510" height="23" colspan="3"><input type="text" name="switch_porta" size="12" style="border-style: inset; border-width: 5"><b><font size="2" color="#070E5A">Quantidade de portas no Hub ou na Switch.</font></b></td>
      </tr>       
      <tr>
        <td class="fundo1" width="90" height="65" align="center"><b>Observação</b></td>
        <td class="fundo3" width="510" height="65" colspan="3"><textarea name="switch_observa" cols="57" rows="6" style="border-style: inset; border-width: 5">Nada a relatar</textarea></td>
      </tr>                
</table>
