...
<table border="1" width="600" height="23">
    ...
    <table border="1" width="600" height="121">
      <tr>
      ...
      <tr>
        <td class="fundo1" width="100" height="23" align="center"><b>Data Fechamento</b></td>
        <td class="fundo3" width="150" height="23"><%=rsbanco("os_dataconc")%></td>
        <td class="fundo1" width="100" height="23" align="center"><b>Militar Fechou</b></td>
        <td class="fundo3" width="150" height="23"><%=rsbanco("os_militarconc")%></td>
      </tr>       
      <tr>
        <td class="fundo1" width="100" height="134" align="center"><b>Observação</b><p><b>de</b></p><p><b>Fechamento</b></td>
        <td class="fundo3" width="500" height="134" colspan="3"><%=rsbanco("os_observconc")%></td>
      </tr>     
      <tr>
        <td class="fundo1" width="100" height="23" align="center"><b>Militar Recebeu</b></td>
        <td class="fundo3" width="150" height="23"><%=rsbanco("os_milrecconc")%></td>
        <td class="fundo1" width="100" height="23" align="center"><b>Status da OS</b></td>
<% If rsbanco("os_status") = 1 then %>
	  <td class="fundo3" width="150" height="29" align="center"><img border="0" src="bolaverde.gif"></td>      
<% Else
		If rsbanco("os_status") = 2 then %>
      <td class="fundo3" width="150" height="29" align="center"><img border="0" src="bolaamarela.gif"></td>
		<% Else
			If rsbanco("os_status") = 3 then %>
      <td class="fundo3" width="150" height="29" align="center"><img border="0" src="bolaazul.gif"></td>		
			<% Else %>
      <td class="fundo3" width="150" height="29" align="center"><img border="0" src="bolavermelha.gif"></td>
			<% End If
		End If
	End If %>        
      </tr>           
