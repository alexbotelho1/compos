...
<table border="1" width="780" height="30">
    <tr>
      	<form method="GET" action="auditoria_solicitacao.asp">
      		...
      		<td class="fundo3" width="120" height="30" align="center"><input type="text" name="pesquisa_sol" size="10" style="border-style: inset; border-width: 5; background-color:#FFFF00; text-align:center"></td>
      	...
      	<form method="GET" action="auditoria_ordem.asp">
      		...
      		<td class="fundo3" width="120" height="30" align="center"><input type="text" name="pesquisa_os" size="10" style="border-style: inset; border-width: 5; text-align:center"></td>
      		<td class="fundo5" width="120" height="30" align="center"><input type="submit" value="Procurar"></td>
      	</form>
    </tr>
</table>
