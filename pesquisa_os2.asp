...
<table border="0" cellpadding="0" cellspacing="0" width="740">		  
	<tr>
		<td align="center"><font face="Trebuchet MS" size="2" color="#FFFFFF"><i>Você não informou algum intervalo de pesquisa! Volte e corrija esse problema (erro <% = erro %>).</i></font></td>
	</tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" width="740">		  
	<tr>
		<td align="center"><font face="Trebuchet MS" size="2" color="#FFFFFF"><i>Pesquisa sem resultado! Volte e informe outros dados à pesquisa.</i></font></td>
	</tr>
</table>
<form action="javascript:history.go(-1)"><input type="submit" value="&nbsp;&nbsp;&nbsp;Voltar&nbsp;&nbsp;&nbsp;"></form></center>
<% End If %>
