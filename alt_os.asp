...
<body><center><form method="GET" action="alt2.asp">
...
<table border="1" width="600" height="23">
    ...
    <table border="1" width="600" height="23">
      <tr>
        <td class="fundo2" width="600" height="23" align="center" colspan="4"><font color="#008000"><b>Formulário de Fechamento de Ordem de Serviço</b></font></td>
      </tr>    
      <tr>
        <td class="fundo1" width="150" height="23" align="center"><b>Data Fechamento</b></td>
        <td class="fundo3" width="150" height="23"><input readonly value="<%=rsbanco("os_dataconc")%>" name="os_dataconc" type="text" size="20" style="text-align: center"></td>
        <td class="fundo1" width="150" height="23" align="center"><b>Militar Fechou</b></td>
        <td class="fundo3" width="150" height="23">
	<% 	Set rsbanco2 = Server.CreateObject("ADODB.Recordset")
		rsbanco2.Open "SELECT * FROM sti ORDER BY sti_antiguidade ASC",banco,AdOpenKeySet,AdLockOptimistic %>					  
			<select name="os_militarconc">					    
		<%  Do While Not rsbanco2.EOF %>								    
				<option value="<% = rsbanco2("sti_nomeguerra") %>" <% If rsbanco("os_militarconc") = rsbanco2("sti_nomeguerra") Then Response.Write (" selected") %>><% = rsbanco2("sti_nomeguerra") %></option>
		<% 		rsbanco2.MoveNext 
			Loop %>											  
			</select>					  
	<% 	rsbanco2.Close
      ...
      <tr>
        <td class="fundo1" width="150" height="120" align="center"><b>Observação</b><p><b>de</b></p><p><b>Fechamento</b></td>
        <td class="fundo3" width="450" height="120" colspan="3"><textarea name="os_observconc" cols="55" rows="8"><%=rsbanco("os_observconc")%></textarea></td>
      </tr>     
      <tr>
        <td class="fundo1" width="150" height="23" align="center"><b>Militar Recebeu</b></td>
        <td class="fundo3" width="150" height="23"><input value="<%=rsbanco("os_milrecconc")%>" type="text" name="os_milrecconc" size="20"></td>
        <td class="fundo1" width="150" height="23" align="center"><b>Status da OS</b></td>
        <td class="fundo3" width="150" height="23"><input value="<%=rsbanco("os_status")%>" type="text" name="os_status" size="20"></td>
      </tr>           
    </table>
<table border="0" cellpadding="0" cellspacing="0" width="600" height="21">
	<tr>
	  <td width="180" height="21" align="right"><font color="#FFFFFF" size="2">&nbsp;Status da OS =&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td width="20" height="21"><font size="1"><img border="0" src="bolavermelha.gif"></font></td>
      <td width="120" height="21"><font color="#FFFFFF" size="1">OS Não Aberta = </font><b><font color="#FFFFFF">0</b></td>
      <td width="20" height="21"><font size="1"><img border="0" src="bolaverde.gif"></font></td>
      <td width="100" height="21"><font color="#FFFFFF" size="1">OS Aberta = </font><font color="#FFFFFF"><b>1</b></td>
      <td width="20" height="21"><font size="1"><img border="0" src="bolaamarela.gif"></font></td>
      <td width="110" height="21"><font color="#FFFFFF" size="1">OS Paralisada = </font><font color="#FFFFFF"><b>2</b></td>
      <td width="20" height="21"><font size="1"><img border="0" src="bolaazul.gif"></font></td>
      <td width="110" height="21"><font color="#FFFFFF" size="1">OS Fechada =</font><font color="#FFFFFF"><b>3</b></td>
    </tr>
</table>             
