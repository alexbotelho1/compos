...
<% 	set rsbanco=server.createobject("ADODB.Recordset")
		rsbanco.open "Select * from modimp",banco,AdOpenKeySet,AdLockOptimistic
		
If Trim(Request.querystring("modimp_nome")) = "" Then
...
Else
	...
	modimp_nome=request.querystring("modimp_nome")
	
	rsbanco.AddNew
	rsbanco("modimp_nome")=modimp_nome
	rsbanco.Update
