...
<% Else
      ...
      <td class="fundo5" width="40" height="27" align="center"><img border="0" src="bolavermelha.gif"></td>
		...
		End If
	End If %>
      <td width="50" height="29" align="center" bgcolor="#00FFFF"><% If rsbanco("os_numero") > 0 Then %><a href="os.asp?codsolic=<% = rsbanco("os_codigo") %>"><% End If %><font color="#7F0D11" size="2"><b><% = rsbanco("os_numero") %></td>	
</tr>
<% 		HowMany = HowMany + 1
		rsbanco.MoveNext
	Else
...
<table border="1" width="750" height="30">
    <tr>
      	<form method="GET" action="consultas_solicitacao.asp">
      		...
      		<td class="fundo3" width="125" height="30" align="center"><input type="text" name="pesquisa_sol" size="10" style="border-style: inset; border-width: 5; text-align:center"></td>
...
<table border="0" cellpadding="0" cellspacing="0" width="750" align="center">		  
	<tr>
		<form action="consultas_completa.asp"><td align="center" width="750"><input type="submit" value="&nbsp;&nbsp;&nbsp;Voltar&nbsp;&nbsp;&nbsp;"></td></form>
	</tr>
</table>
