...
<% 	set rsbanco=server.createobject("ADODB.Recordset")
		rsbanco.open "Select * from periferico",banco,AdOpenKeySet,AdLockOptimistic
		
If Trim(Request.querystring("periferico_nome")) = "" Then
...
Else
	...
	periferico_nome=request.querystring("periferico_nome")
	
	rsbanco.AddNew
	rsbanco("periferico_nome")=periferico_nome
	rsbanco.Update
