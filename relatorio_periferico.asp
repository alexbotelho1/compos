...
<%  If Session("LoggedIn") = True Then
	...
	periferico=request.querystring("os_solicperiferico")
...
<% Else %>    
	<tr>
    	<td width="700" height="23" colspan="2" align="center" style="border-left: 1px solid #000000; border-right: 1px solid #000000; border-top: 1px solid #000000; border-bottom-width: 1"><i><b>Relatório por Periférico(<font color="#FF0000"><% = periferico %></font>) do Exercício de <% = anoatual %></b></i></td>
    </tr>    
    </table>
...
Do While Not rsbanco.EOF
	...
	Do While Not rsbanco.EOF And cont1 < 1 
		If rsbanco("os_solicperiferico") = periferico And rsbanco("os_ano") = anoatual then %>  			
    			<tr>
