...
<body><center><form method="GET" action="add5.asp">
...
<table border="1" width="600" height="102">
    <tr>
      ...
      <td width="504" height="102" align="center" class="fundo2">
...
<table border="1" width="600" height="268">
      <tr>
        ...
        <td class="fundo3" width="91" height="23"><input readonly name="os_solicdata" type="text" value="<% Response.write Now %>" size="20" style="border-style: inset; border-width: 5; text-align:center"></td>
        <td class="fundo1" width="154" height="23" align="center"><b>Periférico</b></td>
        <td class="fundo3" width="521" height="23" colspan="3">
	...
	<% 	rsbanco5.Close
      ...
      <tr>
        ...
        <td class="fundo3" width="505" height="146" colspan="3"><textarea name="os_solicdescricao" cols="60" rows="9" style="border-style: inset; border-width: 5">Se estiver solicitando Senha/Login favor informar:       Nome Completo, Nome de Guerra, Senha Sugerida e o        Sistema(E-mail, Rede, Internet...)</textarea></td>
      </tr>
      <tr>
        <td class="fundo1" width="81" height="23" align="center"><b>Solicitante</b></td>
        <td class="fundo3" width="91" valign="middle" height="23"><input type="text" name="os_solicmilitar" size="20" style="border-style: inset; border-width: 5"></td>
	...
	<% 	rsbanco3.Close
        ...
        <td class="fundo3" width="523" valign="middle" height="23"><input type="text" name="os_solicramal" size="12" style="border-style: inset; border-width: 5"></td>
      </tr>       
    </table>
<input type="submit" value="Salvar" name="BTincluir">&nbsp;&nbsp;&nbsp;&nbsp;<input type="reset" value="Limpar" name="BTlimpar"></form>
<form action="cad_sol.asp"><input type="submit" value="&nbsp;&nbsp;&nbsp;Voltar&nbsp;&nbsp;&nbsp;">
