...
<% 	set rsbanco=server.createobject("ADODB.Recordset")
		rsbanco.open "Select * from secao",banco,AdOpenKeySet,AdLockOptimistic
		
If Trim(Request.querystring("secao_nome")) = "" Then
...
Else
	...
	secao_nome=request.querystring("secao_nome")
	
	rsbanco.AddNew
	rsbanco("secao_nome")=secao_nome
	rsbanco.Update
