...
<tr class="fundo1">
	  <td width="80" height="14" align="center"><a href="consultas_completa2.asp?Ordem=1&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=2&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></a></td>
      <td width="140" height="14" align="center"><a href="consultas_completa2.asp?Ordem=3&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=4&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></a></td>
	  <td width="110" height="14" align="center"><a href="consultas_completa2.asp?Ordem=5&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=6&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></a></td>
	  <td width="130" height="14" align="center"><a href="consultas_completa2.asp?Ordem=7&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=8&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></a></td>
      <td width="70" height="14" align="center"><a href="consultas_completa2.asp?Ordem=9&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=10&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></td>
      <td width="130" height="14" align="center"><a href="consultas_completa2.asp?Ordem=11&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=12&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></td>
      <td width="50" height="14" align="center"><a href="consultas_completa2.asp?Ordem=13&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=14&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></td>
	  <td width="40" height="14" align="center"><a href="consultas_completa2.asp?Ordem=15&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=16&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></td>
	  <td width="70" height="14" align="center"><a href="consultas_completa2.asp?Ordem=17&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;&nbsp;<a href="consultas_completa2.asp?Ordem=18&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></td> 	    
</tr>
	<tr class="fundo1">
	  <td width="80" height="29" align="center"><a href="consultasos2.asp?Ordem=1&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta.gif" alt="Crescente"></a>&nbsp;<font size="2"><b>N° OS</b></font>&nbsp;<a href="consultasos2.asp?Ordem=2&page=<% = (rsbanco.AbsolutePage) %>"><img border="0" src="seta2.gif" alt="Decrescente"></a></td>
