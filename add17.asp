...
<% 	set rsbanco=server.createobject("ADODB.Recordset")
		rsbanco.open "Select * from nobreakpt",banco,AdOpenKeySet,AdLockOptimistic
		
If Trim(Request.querystring("nobreakpt_nome")) = "" Then
...
Else
	...
	nobreakpt_nome=request.querystring("nobreakpt_nome")
	
	rsbanco.AddNew
	rsbanco("nobreakpt_nome")=nobreakpt_nome
	rsbanco.Update
